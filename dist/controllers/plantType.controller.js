...
export const listPlantTypes = async (req, res, next) => {
    try {
...
export const getPlantType = async (req, res, next) => {
    try {
...
export const createPlantType = async (req, res, next) => {
    try {
...
export const updatePlantType = async (req, res, next) => {
    try {
...
export const deletePlantType = async (req, res, next) => {
    try {
