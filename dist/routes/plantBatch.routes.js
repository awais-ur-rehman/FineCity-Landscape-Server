...
router.get('/', rbac('admin', 'employee'), validate(listPlantBatchQuerySchema, 'query'), plantBatchController.listBatches);
...
router.post('/', rbac('super_admin', 'admin'), validate(createPlantBatchSchema), plantBatchController.createBatch);
/** PUT /plant-batches/:id — admin only */
router.put('/:id', rbac('super_admin', 'admin'), validate(updatePlantBatchSchema), plantBatchController.updateBatch);
