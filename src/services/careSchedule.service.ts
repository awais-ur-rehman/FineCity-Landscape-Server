import CareSchedule, { ICareSchedule } from '../models/CareSchedule.js';
...
export const listSchedules = async ({ branchId, batchId, careType, isActive, page = 1, limit = 20 }: ListSchedulesQuery) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const createSchedule = async (data: any, userId: string) => {
